  ...
  _createClass(MemoryGame, [{
    ...
    */
    ...
    value: function dbWrite() {
      ...
      this.state.serverData.dataPack.score = 34;
      socket.emit(this.state.gameName, this.state.serverData.dataPack);
    }
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            { className: 'highScoreButton', id: 'highScoreButton', onClick: this.dbWrite },
            'write '
          )
        ),
        React.createElement(
          'div',
          { className: 'memory-highscore-container', id: 'memory-highscore-container' },

class CardListDemoGet7{
    constructor() {
        this.cardlocation = "/assets/cardsDemo/get7/";
        this.audiolocation = "/assets/cardsDemo/get7";        
        this.cardList = []
        this.CardListGet7 =[];
        this.cardSets =[
    ...
    createCardList(){
        let cardlocation = "/assets/cardsDemo/";
        let audiolocation = "/assets/cardsDemo/";
        let maxCards = 51;
        let checkCardNo = 0;
